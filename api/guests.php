...
<style>
    ...
    .device { width: min(360px, 95vw); height: min(95vh, calc(min(360px, 95vw) * 16 / 9)); aspect-ratio: 9 / 16; background: #fff; display: flex; flex-direction: column; overflow: hidden; text-align: center; }
    ...
    .code { font-size: 1.6rem; font-weight: 700; color: #000; margin: 0; letter-spacing: 0.25em; margin-top: 0.6rem; width: 120px; display: block; margin-left: auto; margin-right: auto; white-space: nowrap; }
    .qr { max-width: 70px; width: 40%; height: auto; margin: 0 auto 0.2rem; border-radius: 12px; background: transparent; }
