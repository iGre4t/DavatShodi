...
<body class="page-loading">
  ...
  <span class="ohterparts">همراه ما باشید</span>
        ...
        <p class="subtitle">
          کمپین «به نام خدا» از ۳ اسفند شروه می‌شود و مسیر چالش‌ها تا ۱۸ فروردین به‌صورت مرحله‌ای فعال خواهد شد. با مشارکت مستمر در این بازه، می‌توانید امتیاز جمع‌آوری کرده و شانس دریافت جایزه را افزایش دهید.
        </p>
