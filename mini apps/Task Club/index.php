  ...
  <span class="ohterparts"> همراه شوید</span>
      ...
      <div class="content">
        ...
        <section class="section">
          ...
          <p>
            نام کاربری و رمز عبور اختصاصی هر نفر از طریق سرشماره <b>8919</b> به شماره موبایل سازمان پیامک می‌شود. اطلاعات ورود شخصی است و امکان استفاده مشترک از حساب کاربری وجود ندارد.
          </p>
        </section>
        ...
        <section class="section">
          <h3>پشتیبانی</h3>
          <p>
            در صورت وجود سوال یا ابهام، از طریق روبیکا با آیدی <b>@ero_admin</b> در ارتباط باشید.
          </p>
        </section>
