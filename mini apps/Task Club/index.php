...
<body class="page-loading">
  ...
  <span class="ohterparts">همراه ما باشید</span>
        ...
        <p class="subtitle">
          با شروع کمپین به نام خدا مسیر چالش‌ها از ۳ اسفند تا ۱۸ فروردین به‌صورت مرحله‌ای فعال می‌شوند و با مشارکت مستمر می‌توانید امتیاز جمع کنید و شانس دریافت جایزه داشته باشید.
        </p>
        <div class="badge">مجموع امتیازات کمپین: 530 امتیاز</div>
      </section>
      ...
      <div class="content">
        <section class="section">
          <h3>هدف کمپین</h3>
          <p>
            کمپین «به نام خدا» برای ایجاد تجربه‌ای پویا، مشارکتی و متفاوت طراحی شده است تا افزایش تعامل، یادگیری و حضور مستمر همکاران را فراهم کند..
          </p>
        </section>
        ...
        <section class="section">
          ...
          <ul class="list">
            ...
            <li><b>چالش فردی «الهی‌نامه»:</b> فعالیت فردی با تمرکز بر تفکر و خلاقیت.</li>
        ...
        <section class="section">
          ...
          <ul class="list">
            ...
            <li>چالش جمعی «به نقش ایران»: <b>از 100 تا 300 امتیاز</b> (ثبت پس از ارزیابی نهایی)</li>
            <li>امتیاز چالش جمعی با توجه به معیارهای داوری مشخص می‌شود.</li>
        ...
        <section class="section">
          ...
          <p>
            در پایان کمپین، امتیازها به کارت شانس تبدیل می‌شوند. به ازای هر <b>از 100 تا 400 امتیاز</b> یک کارت شانس دریافت می‌کنید و جایزه هر کارت همان لحظه مشخص می‌شود. همچنین افرادی که امتیاز کامل <b>530</b> را کسب کنند، در قرعه‌کشی ویژه نیز حضور خواهند داشت.
          </p>
        </section>
        ...
        <section class="section">
          ...
          <p>
            نام کاربری و رمز عبور اختصاصی هر فرد از طریق سرشماره <b>8919</b> به شماره موبایل سازمان پیامک می‌شود.اطلاعات ورود کاملاً محرمانه و شخصی است و استفاده مشترک از حساب کاربری مجاز نیست.
          </p>
        </section>
