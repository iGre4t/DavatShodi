...
<link rel="stylesheet" href="mini%20apps/missions/BeDastAvardim/tc-panel.css?v=<?= htmlspecialchars($tcPanelCssVer, ENT_QUOTES, 'UTF-8') ?>" />
...
<?php endif; ?>
  ...
  <div class="field">
    <a class="btn primary standard-primary-button" href="mini%20apps/missions/BeDastAvardim/TCM.php" target="_blank" rel="noopener">باز کردن تسک کلاب</a>
  </div>
</div>
      ...
      <div class="card">
        ...
        <div class="field">
          <a
            ...
            href="mini%20apps/missions/BeDastAvardim/export_login_data.php"
            target="_blank"
            rel="noopener"
        ...
        <div class="field">
          <a
            class="btn primary standard-primary-button"
            href="mini%20apps/missions/BeDastAvardim/export_participants.php"
            target="_blank"
            rel="noopener"
        ...
        <div class="field">
          <a
            class="btn primary standard-primary-button"
            href="mini%20apps/missions/BeDastAvardim/valuable_prizes_export.php"
            target="_blank"
            rel="noopener"
        ...
        <div id="tc-invitee-prize-totals-modal" class="modal hidden" role="dialog" aria-modal="true" aria-labelledby="tc-invitee-prize-totals-title">
          <div class="modal-card default-modal-card">
            ...
            <div class="modal-actions">
              <form method="post" action="mini%20apps/missions/BeDastAvardim/invitees_prize_totals_export.php" target="_blank" data-tc-prize-totals-form>
        ...
        <div class="field">
          <a
            class="btn primary standard-primary-button"
            href="mini%20apps/missions/BeDastAvardim/prize_winners_log.php"
            target="_blank"
            rel="noopener"
        ...
        <?php
          ...
          foreach ($tcPrizeLevels as $tcPrizeLevel):
            ...
            $tcPotExportBase = 'mini%20apps/missions/BeDastAvardim/pot_export.php?level_id=' . rawurlencode($tcPotLevelId);
        ?>
        <div class="field">
...
<script src="mini%20apps/missions/BeDastAvardim/tc-panel-local.js?v=<?= htmlspecialchars($tcPanelLocalJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php else: ?>
<?php if ($tcRequestedPane === 'tc-rewards-config'): ?>
<script src="mini%20apps/missions/BeDastAvardim/TC%20Prizes.js?v=<?= htmlspecialchars($tcPrizesJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($tcRequestedPane === 'tc-main' || $tcRequestedPane === 'tc-rewards-config'): ?>
<script src="mini%20apps/missions/BeDastAvardim/TCSetting.js?v=<?= htmlspecialchars($tcSettingJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($tcRequestedPane === 'tc-main' && $tcCanEventStylePane): ?>
<script src="mini%20apps/missions/BeDastAvardim/TCEventStyle.js?v=<?= htmlspecialchars($tcEventStyleJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($tcRequestedPane === 'tc-main' && $tcCanTaskAccessPane): ?>
<script src="mini%20apps/missions/BeDastAvardim/TCTaskAccess.js?v=<?= htmlspecialchars($tcTaskAccessJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($tcRequestedPane === 'tc-monitoring'): ?>
<script src="mini%20apps/missions/BeDastAvardim/TCMonitoring.js?v=<?= htmlspecialchars($tcMonitoringJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php endif; ?>
