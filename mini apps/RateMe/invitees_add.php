...
$tcInviteesAddSessionUser = requireTabPermissionFromSession('rate-me', true);
if (!userHasPermissionId($tcInviteesAddSessionUser, 'rate-me:invitees')) {
  denyPanelAccess(403, 'You do not have permission to access this RateMe section.', true);
}
$tcInviteesAddSpecialAccess = tcInviteesSpecialAccessForPanelUser($tcInviteesAddSessionUser, __DIR__ . '/tasks/task-access.json');
if (empty($tcInviteesAddSpecialAccess['manageInvitees'])) {
