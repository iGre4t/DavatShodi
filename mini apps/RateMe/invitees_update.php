...
$tcInviteesUpdateSessionUser = requireTabPermissionFromSession('rate-me', true);
if (!userHasPermissionId($tcInviteesUpdateSessionUser, 'rate-me:invitees')) {
  denyPanelAccess(403, 'You do not have permission to access this RateMe section.', true);
}
$tcInviteesUpdateSpecialAccess = tcInviteesSpecialAccessForPanelUser($tcInviteesUpdateSessionUser, __DIR__ . '/tasks/task-access.json');
if (empty($tcInviteesUpdateSpecialAccess['editInvitee'])) {
