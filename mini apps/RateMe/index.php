...
<head>
  ...
  <title>خودارزیابی زندگی ادامه دارد</title>
  ...
  <main class="app">
    <section class="phone">
      ...
      <section class="hero">
        ...
        <?php endif; ?>
        <h1 class="title">
  <span class="ohterparts">خودارزیابی روان‌شناختی کمپین</span>
  <span class="highlight">«زندگی ادامه دارد»</span>
  <br>
  <span class="ohterparts">فرصتی برای مکث و خودارزیابی</span>
</h1>

        <div class="badge">مهلت خودارزیابی : پنجشنبه تا شنبه 24 تا 26 اردیبهشت</div>
      </section>

      <div class="content">
        <section class="section">
          <h3>درباره خودارزیابی</h3>
          <p>
            خودارزیابی کمپین «زندگی ادامه دارد» برای نگاهی کوتاه‌تر و دقیق‌تر به وضعیت روحی و حال این روزهای شما طراحی شده است. این صفحه یک فضای ساده برای انجام یک ارزیابی فردی است، نه یک مسیر رقابتی یا چالشی.
          </p>
        </section>
        ...
        <section class="section">
          ...
          <ul class="list">
            <li><b>معرفی خودارزیابی:</b> توضیح کوتاهی درباره هدف و فضای ارزیابی.</li>
            <li><b>راهنمای مسیر:</b> اطلاعات لازم برای ورود و انجام خودارزیابی.</li>
        ...
        <section class="section">
          <h3>نحوه شرکت</h3>
          <p>
            کافی است در زمان اعلام‌شده از طریق نام کاربری و رمز عبور شخصی خود وارد شده و سوال‌ها را براساس وضعیت واقعی خودتان در دو هفته اخیر پاسخ دهید.
          </p>
        </section>
        <section class="section">
        ...
        <div class="cta-wrap">
          <a class="cta" href="rmsM.php">شروع خودارزیابی</a>
          <p class="support">برای ادامه، روی دکمه بالا بزنید و وارد صفحه خودارزیابی شوید.</p>
        </div>
      </div>
    </section>
  </main>
