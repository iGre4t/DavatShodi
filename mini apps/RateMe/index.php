...
<body class="page-loading">
  ...
  <span class="ohterparts">همراه ما باشید</span>
        ...
        <p class="subtitle">
          کمپین «به نام خدا» از ۳ اسفند شروع می‌شود و مسیر چالش‌ها تا ۱۸ فروردین به‌صورت مرحله‌ای فعال خواهد شد. با مشارکت مستمر در این بازه، می‌توانید امتیاز جمع‌آوری کرده و شانس دریافت جایزه را افزایش دهید.
        </p>
      ...
      <div class="content">
        ...
        <section class="section">
          ...
          <ul class="list">
            <li>هر چالش سوالی در زمان مشخص شده: <b>۳۰ امتیاز</b></li>
            <li>چالش سوالی بعد از زمان مشخص شده: <b>۱۵ امتیاز</b></li>
        ...
        <section class="section">
          ...
          <p>
            در پایان کمپین، امتیازها به کارت شانس تبدیل می‌شوند. به ازای هر <b>100 امتیاز</b> یک کارت شانس دریافت می‌کنید و جایزه هر کارت همان لحظه مشخص می‌شود. همچنین افرادی که امتیاز کامل <b>530</b> را کسب کنند، در قرعه‌کشی ویژه نیز شرکت داده خواهند شد. 
          </p>
        </section>
        ...
        <div class="cta-wrap">
          <a class="cta" href="rmsM.php">شرکت در چالش</a>
