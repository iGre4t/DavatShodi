...
$tcMonitoringSessionUser = requireTabPermissionFromSession('rate-me', $tcMonitoringIsJsonRequest);
if (!userHasPermissionId($tcMonitoringSessionUser, 'rate-me:monitoring')) {
...
function tcMonitoringBuildStats(string $baseDir): array
{
  ...
  $inviteesPath = $baseDir . DIRECTORY_SEPARATOR . 'rms Event' . DIRECTORY_SEPARATOR . 'Invitees mapped.csv';
  $inviteesMapPath = $baseDir . DIRECTORY_SEPARATOR . 'rms Event' . DIRECTORY_SEPARATOR . 'rms Mapped.json';
  $prizesPath = $baseDir . DIRECTORY_SEPARATOR . 'rms Prizes.json';
