...
$tcPanelUser = requireTabPermissionFromSession('rate-me', false);
$tcAllowedChildTabs = resolveAllowedPanelChildTabsForUser($tcPanelUser, 'rate-me');
$tcAllowedChildSet = array_fill_keys($tcAllowedChildTabs, true);
$tcCanMainPane = isset($tcAllowedChildSet['rate-me:main']);
$tcCanInviteesPane = isset($tcAllowedChildSet['rate-me:invitees']);
$tcCanManageTasksPane = isset($tcAllowedChildSet['rate-me:manage-tasks']);
$tcCanTaskAccessPane = isset($tcAllowedChildSet['rate-me:task-access']);
$tcCanMonitoringPane = isset($tcAllowedChildSet['rate-me:monitoring']);
$tcCanExportPane = isset($tcAllowedChildSet['rate-me:export']);
$tcCanEventStylePane = isset($tcAllowedChildSet['rate-me:event-style']);
...
$tcPanelCssVer = (string)(@filemtime(__DIR__ . '/rms-panel.css') ?: time());
$tcPanelLocalJsVer = (string)(@filemtime(__DIR__ . '/rms-panel-local.js') ?: time());
$tcPrizesJsVer = (string)(@filemtime(__DIR__ . '/rms Prizes.js') ?: time());
$tcSettingJsVer = (string)(@filemtime(__DIR__ . '/rmsSetting.js') ?: time());
$tcEventStyleJsVer = (string)(@filemtime(__DIR__ . '/rmsEventStyle.js') ?: time());
$tcMonitoringJsVer = (string)(@filemtime(__DIR__ . '/rmsMonitoring.js') ?: time());
$tcTaskAccessJsVer = (string)(@filemtime(__DIR__ . '/rmsTaskAccess.js') ?: time());
?>

<link rel="stylesheet" href="mini%20apps/RateMe/rms-panel.css?v=<?= htmlspecialchars($tcPanelCssVer, ENT_QUOTES, 'UTF-8') ?>" />
<div class="rms-shell" data-rms-csrf="<?= htmlspecialchars($tcPanelCsrfToken, ENT_QUOTES, 'UTF-8') ?>">
<div class="sub-layout" data-tc-sub-layout>
  <aside class="sub-sidebar">
    <div class="sub-header">RateMe</div>
    <div class="sub-nav">
  ...
  <div class="field">
    <a class="btn primary standard-primary-button" href="mini%20apps/RateMe/rmsM.php" target="_blank" rel="noopener">Open RateMe</a>
  </div>
</div>
...
<div class="card">
  ...
  <div class="table-wrapper">
    ...
    <div class="sub-pane<?= $tcInitialPane === 'tc-monitoring' ? ' active' : '' ?>" data-pane="tc-monitoring">
      <?php include __DIR__ . '/rmsMonitoring.php'; ?>
    </div>
    <?php endif; ?>
    <?php if ($tcCanExportPane): ?>
      ...
      <div class="card">
        ...
        <div class="field">
          <a
            ...
            href="mini%20apps/RateMe/export_login_data.php"
            target="_blank"
            rel="noopener"
          >Export Login Data</a>
        </div>
    ...
    <?php if (!$tcHasAnyPane): ?>
      <div class="card">
        ...
        <p class="muted">You do not have access to any RateMe subtab.</p>
      </div>
    <?php endif; ?>
  </div>
</div>
...
<?php endif; ?>
<?php if ($tcCanEventStylePane): ?>
<script src="mini%20apps/RateMe/rmsEventStyle.js?v=<?= htmlspecialchars($tcEventStyleJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($tcCanTaskAccessPane): ?>
<script src="mini%20apps/RateMe/rmsTaskAccess.js?v=<?= htmlspecialchars($tcTaskAccessJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($tcCanMonitoringPane): ?>
<script src="mini%20apps/RateMe/rmsMonitoring.js?v=<?= htmlspecialchars($tcMonitoringJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
