...
function tctBuildTaskDescribePhotoUrl(string $tagCode, string $fileName): string
{
  ...
  $base = 'mini%20apps/EGMs/EGM/egm_asset.php?path=';
...
function tctSaveStoreTasks(string $storePath, array $tasks): bool
{
  ...
  try {
    return egmInstanceWriteMissionPeriodsUsingProjectConfig(dirname(__DIR__, 3), __DIR__, array_values($tasks));
...
<script>
(() => {
  const endpoint = 'mini%20apps/EGMs/EGM/EGMT.php';
