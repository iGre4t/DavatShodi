...
<div class="sub-layout" data-egm-sub-layout>
  ...
  <div class="field" style="display:flex;flex-wrap:wrap;gap:10px;align-items:center;">
    <a class="btn primary standard-primary-button" href="mini%20apps/EGMs/EGM/EGMM.php" target="_blank" rel="noopener">باز کردن صفحه رویداد</a>
  </div>
</div>
      ...
      <div class="card">
        ...
        <div class="field">
          <a
            ...
            href="mini%20apps/EGMs/EGM/export_login_data.php"
            target="_blank"
            rel="noopener"
        ...
        <div class="field">
          <a
            class="btn primary standard-primary-button"
            href="mini%20apps/EGMs/EGM/export_participants.php"
            target="_blank"
            rel="noopener"
        ...
        <div class="field">
          <a
            class="btn primary standard-primary-button"
            href="mini%20apps/EGMs/EGM/valuable_prizes_export.php"
            target="_blank"
            rel="noopener"
        ...
        <?php
          ...
          foreach ($egmPrizeLevels as $egmPrizeLevel):
            ...
            $egmPotExportBase = 'mini%20apps/EGMs/EGM/pot_export.php?level_id=' . rawurlencode($egmPotLevelId);
        ?>
        <div class="field">
...
<?php endif; ?>
<?php if ($egmCanMainPane): ?>
<script src="mini%20apps/EGMs/EGM/EGM%20Prizes.js?v=<?= htmlspecialchars($egmPrizesJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($egmCanControlPanel): ?>
<script src="mini%20apps/EGMs/EGM/EGMSetting.js?v=<?= htmlspecialchars($egmSettingJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($egmCanEventStylePane): ?>
<script src="mini%20apps/EGMs/EGM/EGMEventStyle.js?v=<?= htmlspecialchars($egmEventStyleJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($egmCanTaskAccessPane): ?>
<script src="mini%20apps/EGMs/EGM/EGMTaskAccess.js?v=<?= htmlspecialchars($egmTaskAccessJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($egmCanMonitoringPane): ?>
<script src="mini%20apps/EGMs/EGM/EGMMonitoring.js?v=<?= htmlspecialchars($egmMonitoringJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
