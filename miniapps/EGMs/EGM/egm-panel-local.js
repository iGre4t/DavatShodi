(() => {
  const TASKS_ENDPOINT = 'miniapps/EGMs/EGM/EGMT.php';
  const LOGS_ENDPOINT = 'miniapps/EGMs/EGM/egm_logs.php';
  ...
  function buildTaskControlCardMarkup(task) {
    ...
    const quizSrc = `miniapps/EGMs/EGM/EGMQ.php?task_id=${encodeURIComponent(task.id)}`;
