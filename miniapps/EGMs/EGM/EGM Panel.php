...
<link rel="stylesheet" href="miniapps/EGMs/EGM/egm-panel.css?v=<?= htmlspecialchars($egmPanelCssVer, ENT_QUOTES, 'UTF-8') ?>" />
...
<div class="sub-layout" data-egm-sub-layout>
  ...
  <div class="field">
    <a class="btn primary standard-primary-button" href="miniapps/EGMs/EGM/EGMM.php" target="_blank" rel="noopener">باز کردن تسک کلاب</a>
  </div>
</div>
      ...
      <div class="card">
        ...
        <div class="field">
          <a
            ...
            href="miniapps/EGMs/EGM/export_login_data.php"
            target="_blank"
            rel="noopener"
        ...
        <div class="field">
          <a
            class="btn primary standard-primary-button"
            href="miniapps/EGMs/EGM/export_participants.php"
            target="_blank"
            rel="noopener"
        ...
        <div class="field">
          <a
            class="btn primary standard-primary-button"
            href="miniapps/EGMs/EGM/valuable_prizes_export.php"
            target="_blank"
            rel="noopener"
        ...
        <?php
          ...
          foreach ($egmPrizeLevels as $egmPrizeLevel):
            ...
            $egmPotExportBase = 'miniapps/EGMs/EGM/pot_export.php?level_id=' . rawurlencode($egmPotLevelId);
        ?>
        <div class="field">
...
<script src="miniapps/EGMs/EGM/egm-panel-local.js?v=<?= htmlspecialchars($egmPanelLocalJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php if ($egmCanMainPane): ?>
<script src="miniapps/EGMs/EGM/EGM%20Prizes.js?v=<?= htmlspecialchars($egmPrizesJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($egmCanControlPanel): ?>
<script src="miniapps/EGMs/EGM/EGMSetting.js?v=<?= htmlspecialchars($egmSettingJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($egmCanEventStylePane): ?>
<script src="miniapps/EGMs/EGM/EGMEventStyle.js?v=<?= htmlspecialchars($egmEventStyleJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($egmCanTaskAccessPane): ?>
<script src="miniapps/EGMs/EGM/EGMTaskAccess.js?v=<?= htmlspecialchars($egmTaskAccessJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
<?php if ($egmCanMonitoringPane): ?>
<script src="miniapps/EGMs/EGM/EGMMonitoring.js?v=<?= htmlspecialchars($egmMonitoringJsVer, ENT_QUOTES, 'UTF-8') ?>" defer></script>
<?php endif; ?>
